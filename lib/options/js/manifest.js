	...
	OPTIONS = {
		FORMS : {
			"options": [
                ...
                {"name":"dom-timer", "label":"Check for change, in DOM (in seconds)", "type":"text", "html5":"range",  parent:'basicSettings', attr:[{"min":1},{"max":10},{"step":1}]},
                ...
                {"type":"title", "label":"If getting unread number from menu label use <code>a[aria-label^='Inbox'][aria-label$='unread']</code>", parent: "mailSettings", tag: "p"},
		...
		DEFAULT_VALUES : {
            ...
            "inbox-selector" : ".qG",
            "mail-selector" : "tr.apv td.apt span b",
